		...
		else
		{
			...
			{				
				$("#chartDiv").html('<div class="box box-success"><div class="box-header with-border">' 
						...
						+ '<canvas id="lineChart" style="height:300px"></canvas></div></div></div>');
				lineChartStats(jsonChartData);				
			}
...
{		
    ...
    barChartData.datasets[0].fillColor = "#40e0d0";
    barChartData.datasets[0].strokeColor = "#40e0d0";
    barChartData.datasets[0].pointColor = "#40e0d0";
    var barChartOptions = {
...
function lineChartStats(jsonChartData)
{
    ...
    lineChart.Line(jsonChartData, lineChartOptions);    
}
