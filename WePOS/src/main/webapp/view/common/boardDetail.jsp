...
<div class="wrapper">
    ...
    <form name="boardDetail" enctype="multipart/form-data" method="post" action="boardDelete.do">
        ...
        <div class="table-responsive">
          <table id="resultTable" class="table table-bordered table-striped table-hover tablesorter">
			...
			<tr>
				...
				<td><input type="text" size="95%" name="boardTitle" value="${boardDto.boardTitle}" readonly></td>
			</tr>	
			<tr>
          	...
          	<tr>
				...
				<td><textarea rows="20" cols="95%" style="resize: none" name="boardContent" readonly>${boardDto.boardContent}</textarea></td> 
			</tr>
