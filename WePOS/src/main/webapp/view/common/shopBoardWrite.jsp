						...
						<table class="table table-bordered table-striped table-hover tablesorter">
							...
							<tr>
								<td colspan="2" style="vertical-align: middle;" align="right">							
									...
									<button class="btn-u" type="button" style="margin-right: 10px;" onclick="location.href='../common/shopBoardSelectMenu.do?shopCode=${shopCode}&menuType=${menuType}'">목록으로</button>										
								</td>
							</tr>
						</table>
					</form>			
