            ...
            <div class="header-v7 header-left-v7">
                <nav class="navbar navbar-default mCustomScrollbar" role="navigation" data-mcs-theme="minimal-dark"> 
                    ...
                    <div class="menu-container"> 
                        ...
                        <div class="logo"> 
                            <a href="index.html"> 
                                <img id="logo-header" src="<c:url value="/assets/img/logo1-default.png"/>" alt="Logo" /> 
                            </a>                             
                        </div>                         
                        <!-- End Logo -->                         
                    </div>                     
                        ...
                        <div class="menu-container"> 
                            <ul class="nav navbar-nav"> 
                                ...
                                메뉴2</a> 
                                    <ul class="dropdown-menu"> 
                                        <li>
                                            <a href="page_about2.html">하위메뉴1</a>
                                        </li>                                         
                                    </ul>                                     
                                </li>                                 
                                <!-- End About Pages -->                                 
                                ...
                                메뉴3</a> 
                                    <ul class="dropdown-menu"> 
                                        <li>
                                            <a href="blog_large_right_sidebar1.html">메뉴1</a>
                                        </li>
                                    </ul>                                     
                                </li>                                 
                                <!-- End Blog -->                                 
